...
def extract_sunrgbd_data(idx_filename, split, output_folder, num_point=20000,
    ...
    for data_idx in data_idx_list:
        ...
        points_in_boxes = pc_upright_depth_subsampled[point_votes_mask == 1, :]
        # kitti_utils.point_viz(points_in_boxes, name='point_in_boxes')
        # kitti_utils.point_viz(box3d_centers, name='centers')
        point_in_box_votes = point_votes[point_votes_mask == 1, 1:4]
        write_ply_pc(point_in_box_votes + points_in_boxes[:, 0:3], 'recovered_center111.obj')
        a = 1
