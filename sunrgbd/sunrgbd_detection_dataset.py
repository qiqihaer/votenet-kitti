...
class SunrgbdDetectionVotesDataset(Dataset):
    def __init__(self, split_set='train', num_points=20000,
        ...
        # self.scan_names = self.scan_names[0:10]
    ...
    def __getitem__(self, idx):
        ...
        # kitti_utils.box_viz(aug_gt_boxes3d, name='all_boxes')
        points_in_boxes = point_cloud[point_votes_mask == 1, :]
        # kitti_utils.point_viz(points_in_boxes, name='point_in_boxes')
        # kitti_utils.point_viz(box3d_centers, name='centers')
        point_in_box_votes = point_votes[point_votes_mask == 1, 0:3]
        write_ply_pc(point_in_box_votes + points_in_boxes[:, 0:3], 'recovered_center.obj')
